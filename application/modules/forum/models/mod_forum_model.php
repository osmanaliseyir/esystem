...
class mod_forum_Model extends CI_Model {
    ...
    function getItems() {
        ...
        $cond = "WHERE meslek_id='".$this->meslekid."' AND type='1' " . $cond;
    ...
    function setOrd() {
        ...
        $query = $this->db->query("SELECT id,name FROM site_forum WHERE meslek_id='" . $this->meslekid . "' ORDER BY ord ASC");
        $data["ilk"]="En Başa";
        foreach($query->result() as $val){
            $data[$val->id]=$val->name."'den sonra";
        }
        $data["son"]="En Sona";
        return $data;
    }
    ...
    function editsave($id) {
        ...
        $this->db->query("UPDATE site_forum SET name='" . $name . "' WHERE id='" . $id . "'");
