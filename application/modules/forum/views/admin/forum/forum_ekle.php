...
<script type="text/javascript">
    ...
    function formSubmit(){
        $.ajax({
            type:'POST',
            url:'<?php echo base_url() ?>admin/forum/forumlar/save/',
...
<div id="centerPanel" style="width:786px;">
    <div class="block">
        <div class="head"><h3><?= lang("Forum Ekle") ?></h3></div>
        <div style="padding:10px;">
            ...
            <table width="100%" cellpadding="6" cellspacing="0" class="formTable">
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown("meslek_id", $meslekler, "", "id='meslek_id' style='width:200px;' onchange='setOrd(this.value)'") ?></td>
                </tr>
                <tr>
