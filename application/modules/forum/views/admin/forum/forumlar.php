...
<div id="centerPanel" style="width:990px;">
   ...
   <div id="result"></div>
           ...
           <div id="search" style="padding:14px 10px 5px 10px">
            ...
            <?php echo form_button(array("content" => lang("Yeni Forum Ekle"), "class" => "smallblue", "onclick" => "window.location='".base_url()."admin/forum/forumlar/add'")) ?>
            <?php echo form_close() ?>
           </div>
   <div class="block">
      ...
      <input type="hidden" name="checkVal" id="checkVal" value="0"/>
        <table id="example" width="100%" class="display">
         ...
         <tbody>
            ...
            <tr id="row_<?php echo $row->id ?>" bgcolor="#EEEEEE">
            ...
            <tr id="row_<?php echo $row2->id ?>">
               ...
               <td><a href="<?php echo base_url() ?>admin/forum/forumlar/editSubForum/<?php echo $row2->id ?>?token=<?php echo setToken($row2->id)?>">Düzenle</a></td>
               <td><a href="javascript:void(0)" onclick="itemDelete('<?php echo $row2->id ?>','<?php echo setToken($row2->id); ?>')"><img src="images/delete.png"/></a></td>
            </tr>
            <? endforeach; ?>
            <tr>
                <td colspan="6" align="right"><a href="<?=base_url()?>admin/forum/forumlar/addSubForum/<?=$row->id?>">Alt Forum Ekle</a></td>
            </tr>
