...
<script type="text/javascript">
    ...
    function formSubmit(){
        $.ajax({
            type:'POST',
            url:'<?php echo base_url().url_title($this->meslekname) ?>/admin/forumlar/save/',
...
<div id="rightPanel">
    <div class="block">
        <div class="head"><?= lang("Forum Ekle") ?></div>
        <div style="padding:10px;">
            ...
            <table width="100%" cellpadding="6" cellspacing="0" class="formTable">
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown("ord",$ords, "", "id='ord' style='width:200px;'") ?></td>
                </tr>
                <tr>
                    <td></td>
