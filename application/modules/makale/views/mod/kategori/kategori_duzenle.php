...
<script type="text/javascript">
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url().url_title($this->meslekname) ?>/admin/makaleler/kategoriler/editsave/<?php echo $data->id . "?token=" . setToken($data->id) ?>',
         data: $("#categoryForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("Makale Kategorisi Başarıyla Kaydedildi.") ?> "));
               ...
               $("#result").html(resultFormat("alert","<?php echo lang("Makale Kategori Kaydı Yapılamadı!") ?>"));
            }
         }
      });  
   }
