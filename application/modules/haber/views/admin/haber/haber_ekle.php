...
<script type="text/javascript">
   ...
   $(function(){
      $("#description").cleditor({ width:550, height:400});
   });  
   function formSubmit(){
      if( $("#name").val()==""){
         $("#result").html(resultFormat("warning","<?php echo lang("Haber Başlığı Giriniz!") ?>"));   
         return false;
      }
      if( $("#lang").val()==""){
         $("#result").html(resultFormat("warning","<?php echo lang("Haber Dilini Giriniz!") ?>"));   
         return false;
      } 
      if( $("#description").val()==""){
         $("#result").html(resultFormat("warning","<?php echo lang("Haber Açıklaması Giriniz!") ?>"));   
         return false;
      }
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/haber/haberler/save',
         data: $("#pageForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("Haber Başarıyla Eklenmiştir.") ?> "));
            }else if (respond.success=="false") {
               $("#result").html(resultFormat("alert","<?php echo lang("Haber Eklenemedi!") ?>"));
            }
         }
      });  
   }
    ...
    $(function(){
      $('#swfupload-control').swfupload({
         upload_url: "<? echo base_url() ?>admin/haber/haberler/addImage/",
      ...
      .bind('uploadSuccess', function(event, file, serverData){
         ...
         alert(serverData);
            ...
            if(data.success=="false"){
                ...
                $("#photoList").html("<img width='172' src='<?=base_url()?>public/images/haber/"+data.imageurl+"'/>");
...
<div id="leftPanel">
   <div class="block">
      <div class="head"><h3><?= lang("Haber İşlemleri") ?></h3></div>
      <ul class="listMenu">
         <li><a href="<?php echo base_url() ?>admin/haber/haberler"><?php echo lang("Haberler") ?></a></li>
      </ul>
   </div>
</div>
<div id="centerPanel" style="width:786px;">
   <div class="block">
      <div class="head"><h3><?= lang("Haber Ekle") ?></h3></div>
      <div style="padding:10px;">
         ...
         <table width="100%" cellpadding="4" cellspacing="0" class="formTable">
            ...
            <tr>
               <td width="20%"><?php echo lang("Haber Kategorisi", "category") ?></td>
               <td>
            ...
            <tr>
               <td width="20%"><?php echo lang("Haber Dili", "lang") ?></td>
               <td><?php echo form_dropdown("lang", $langs, "controller", "id='lang' style='width:200px;'") ?></td>
            </tr>
            <tr>
               <td ><?php echo lang("Haber Durumu", "active", lang("Durumu pasif olanlar görüntülenmeyecektir.")) ?></td>
               <td><?php echo form_dropdown("active", array("1" => lang("Aktif"), "0" => lang("Pasif")),"", "id='active' style='width:200px;'") ?></td>
            </tr>
            <tr>
                <td><?php echo lang("Haber Resmi","label")?></td>
                <td>
            ...
            <tr>
               <td><?php echo lang("Haber Başlığı", "name") ?></td>
               <td><?php echo form_input(array("name" => "name", "id" => "name", "value" => "", "style" => "width:550px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Haber Alt Başlığı", "subtitle") ?></td>
               <td><?php echo form_textarea(array("name" => "subtitle", "id" => "subtitle", "value" => "", "style" => "height:100px; width:550px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Haber Detayı", "description") ?></td>
               <td><?php echo form_textarea(array("name" => "description", "id" => "description", "value" => "", "style" => "height:400px; width:550px;")) ?></td>
            </tr>
            <tr>
               <td></td>
               <td>
