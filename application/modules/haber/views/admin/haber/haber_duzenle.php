...
<script type="text/javascript">
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/haber/haberler/editsave/<?php echo $data->id . "?token=" . setToken($data->id) ?>',
         data: $("#pageForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("Haber Başarıyla Düzenlendi.") ?> "));
            }else if (respond.success=="false") {
               $("#result").html(resultFormat("alert","<?php echo lang("Haber Düzenlenemedi!") ?>"));
            }
         }
      });  
   }
...
<div id="centerPanel" style="width:786px;">
   <div class="block">
      <div class="head"><h3><?= lang("Haber Düzenle") ?></h3></div>
      <div style="padding:10px;">
         ...
         <table width="100%" cellpadding="4" cellspacing="0" class="formTable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div style="float:left; width:200px; padding:10px;">
                        <div id="photoList"><? 
                        if($data->image!="" && file_exists("public/images/haber/".$data->image."")){
                            echo "<img width='172' src='".base_url()."public/images/haber/".$data->image."'/>";
                        } else {
                            echo lang("Habere Resim Yüklenmemiştir.");
                        }
                        ?></div>
            ...
            <tr>
               ...
               <td><?php echo form_input(array("name" => "name", "id" => "name", "value" => $data->name, "style" => "width:550px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Haber Alt Başlığı", "subtitle") ?></td>
               <td><?php echo form_textarea(array("name" => "subtitle", "id" => "subtitle", "value" => $data->subtitle, "style" => "height:100px; width:550px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Haber Detayı", "description") ?></td>
               <td><?php echo form_textarea(array("name" => "description", "id" => "description", "value" => $data->description, "style" => "height:400px; width:550px;")) ?></td>
            </tr>
            <tr>
               <td></td>
               <td>
