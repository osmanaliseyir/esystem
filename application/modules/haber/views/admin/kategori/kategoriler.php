...
<script type="text/javascript">
   ...
   function itemDelete(id,token){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/haber/category/delete/'+id+'?token='+token,
         dataType:'json',
...
<div id="leftPanel">
   <div class="block">
      <div class="head"><h3><?php echo lang("Haber Kategori İşlemleri") ?></h3></div>
      <ul class="listMenu">
...
<div id="centerPanel" style="width:786px;">
   <div id="result"></div>
   <div class="block">
      <div class="head"><h3><?php echo lang("Haber Kategorileri") ?></h3></div>
      <table id="example" width="100%" class="display">
         ...
         <tbody>
            ...
            <tr id="row_<?php echo $row->id ?>">
               ...
               <td><a href="<?php echo base_url() ?>admin/haber/category/edit/<?php echo $row->id ?>?token=<?php echo setToken($row->id)?>"><img src="images/edit.png"/></a></td>
