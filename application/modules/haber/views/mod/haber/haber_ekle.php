...
<script type="text/javascript">
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url().url_title($this->meslekname) ?>/admin/haberler/save',
         data: $("#pageForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("Haber Başarıyla Eklenmiştir.") ?> "));
               setTimeout("window.location='<?=base_url().url_title($this->meslekname)?>/admin/haberler'",2000);
    ...
    $(function(){
      $('#swfupload-control').swfupload({
         upload_url: "<? echo base_url() ?>common/haberImage/",
      ...
      .bind('uploadSuccess', function(event, file, serverData){
         var item=$('#log li#'+file.id);
            ...
            if(data.success=="false"){
                ...
                $("#photoList").html("<img src='<?=base_url()?>public/images/haber/"+data.imageurl+"'/>");
...
<div id="rightPanel">
   <div class="block">
      <div class="head"><?= lang("Haber Ekle") ?></div>
      <div style="padding:10px;">
         ...
         <table width="100%" cellpadding="4" cellspacing="0" class="formTable">
            ...
            <tr>
               ...
               <td><?php echo form_dropdown("category", $categories, "", "id='category' style='width:200px;'") ?></td>
            ...
            <tr>
               ...
               <td><?php echo form_input(array("name" => "name", "id" => "name", "value" => "", "style" => "width:450px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Haber Alt Başlığı", "subtitle") ?></td>
               <td><?php echo form_textarea(array("name" => "subtitle", "id" => "subtitle", "value" => "", "style" => "height:100px; width:450px;")) ?></td>
            </tr>
            <tr>
               <td colspan="2"><?php echo form_textarea(array("name" => "description", "id" => "description", "value" => "", "style" => "height:400px; width:550px;")) ?></td>
            </tr>
            <tr>
               <td></td>
               <td>
