...
class mod_haber_Model extends CI_Model {
   ...
   function getHaberler() {
      ...
      $cond="";
       ...
       $sql  = "SELECT h.*,c.name as categoryname FROM site_haber as h LEFT JOIN site_haber_category as c ON c.id=h.category";
   ...
   function getCategories() {
      $data = array();
      $query = $this->db->query("SELECT id,name FROM site_haber_category WHERE meslek='".$this->meslekid."'");
