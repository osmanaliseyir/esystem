...
<div id="centerPanel">
   <div class="block">
      <div class="head"><h3><?= lang("Haber Ayarları") ?></h3></div>
      ...
      <div style="padding:10px;">
         <table width="100%" class="formTable" cellpadding="4" cellspacing="0">
           ...
           <tr>
                    <td><?php echo lang("Haber Listeleme Sayısı","haber_rowperpage",lang("Haber Listeleme Sayısını Belirtir.")) ?></td>
                    <td><?php echo form_input(array("name"=>"haber_rowperpage","id"=>"haber_rowperpage","value"=>$data["haber_rowperpage"],"style"=>"width:200px;")) ?></td>
           </tr>
            <tr>
               <td></td>
               <td>
