...
<div id="centerPanel">
   <div class="block">
      <div class="head"><h3><?= lang("İlan Ayarları") ?></h3></div>
      ...
      <div style="padding:10px;">
         <table width="100%" class="formTable" cellpadding="4" cellspacing="0">
           ...
           <tr>
                    <td><?php echo lang("İlan Listeleme Sayısı","firma_rowperpage",lang("İlan Listeleme Sayısını Belirtir.")) ?></td>
                    <td><?php echo form_input(array("name"=>"ilan_rowperpage","value"=>$data["ilan_rowperpage"],"id"=>"ilan_rowperpage","style"=>"width:200px;")) ?></td>
           </tr>
            <tr>
               <td></td>
               <td>
