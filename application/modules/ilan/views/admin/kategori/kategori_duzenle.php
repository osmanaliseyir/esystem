...
function selectParent(id,name){
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/ilan/category/editsave/<?php echo $data->id . "?token=" . setToken($data->id) ?>',
         data: $("#categoryForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("İlan Kategorisi Başarıyla Kaydedildi.") ?> "));
