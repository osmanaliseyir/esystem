...
<script type="text/javascript">
   ...
   function itemDelete(id,token){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/ilan/category/delete/'+id+'?token='+token,
         dataType:'json',
...
<div id="leftPanel">
   <div class="block">
      <div class="head"><h3><?php echo lang("İlan Kategori İşlemleri") ?></h3></div>
      <ul class="listMenu">
         <li><a href="<?php echo base_url() ?>admin/ilan/category/add"><?php echo lang("Yeni Kategori ekle") ?></a></li>
         <li><a href="<?php echo base_url() ?>admin/ilan/category"><?php echo lang("İlan Kategorileri") ?></a></li>
      </ul>
   </div>
</div>
<div id="centerPanel" style="width:786px;">
   <div id="result"></div>
   <div class="block">
      <div class="head"><h3><?php echo lang("İlan Kategorileri") ?></h3></div>
      <table id="example" width="100%" class="display">
         ...
         <tbody>
            ...
            <tr id="row_<?php echo $row->id ?>">
               ...
               <td><?php echo ($row->parent=="0") ? lang("Ana Menü") : $row->parentname  ?></td>
               <td><a href="<?php echo base_url() ?>admin/ilan/category/edit/<?php echo $row->id ?>?token=<?php echo setToken($row->id)?>"><img src="images/edit.png"/></a></td>
