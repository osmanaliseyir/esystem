...
function selectIcon(name){
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/ilan/category/save',
         data: $("#categoryForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("İlan Kategori Başarıyla Kaydedildi.") ?> "));
            }else if (respond.success=="false") {
               $("#result").html(resultFormat("alert","<?php echo lang("İlan Kategori Kaydı Yapılamadı!") ?>"));
            }
         }
      });  
   }
...
<div id="leftPanel">
   <div class="block">
      <div class="head"><h3><?= lang("İlan Kategori İşlemleri") ?></h3></div>
      <ul class="listMenu">
            ...
            <tr>
             ...
             <tr>
               ...
               <td><a href="javascript:void(0)" onclick="pickIcon()"><?php echo lang("Seç") ?></a>
                  <span id="iconValue"></span> <input type="hidden" id="icon" name="icon" value=""/>
               </td>
            </tr>
            <tr>
