...
<script type="text/javascript">
   ...
   function formSubmit(){
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>admin/pages/save',
         data: $("#pageForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               $("#result").html(resultFormat("success","<?php echo lang("Sayfanız Başarıyla Kaydedildi.") ?> "));
            }else if (respond.success=="false") {
               $("#result").html(resultFormat("alert","<?php echo lang("Sayfanızın Kaydı Yapılamadı!") ?>"));
            }
         }
      });  
   }
...
<div id="centerPanel" style="width:786px;">
   <div class="block">
      <div class="head"><h3><?= lang("Sayfa Ekle") ?></h3></div>
      <div style="padding:10px;">
         ...
         <table width="100%" cellpadding="4" cellspacing="0" class="formTable">
            ...
            <tr>
               ...
               <td><?php echo form_dropdown("type", array("1"=>"Alt Menü Sayfası","2" => "Manuel Sayfa"), "1", "id='type' style='width:200px;'") ?></td>
            </tr>
            <tr>
               <td ><?php echo lang("Sayfa Durumu", "active", lang("Sayfa Durumu pasif olanlar görüntülenmeyecektir.")) ?></td>
               <td><?php echo form_dropdown("active", array("1" => lang("Aktif"), "0" => lang("Pasif")), "1", "id='active' style='width:200px;'") ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Sayfa İsmi", "name") ?></td>
               <td><?php echo form_input(array("name" => "name", "id" => "name", "style" => "width:600px;")) ?></td>
            </tr>
            <tr>
               <td><?php echo lang("Sayfa Adres İsmi", "urlname",lang("Eğer başka bir sayfaya eklemeyecekseniz boş bırakın..")) ?></td>
               <td><?php echo form_input(array("name" => "urlname", "id" => "urlname", "style" => "width:200px;")) ?></td>
            </tr>
            <tr>
               <td colspan="2"><?php echo form_textarea(array("name" => "description", "id" => "description", "style" => "height:400px; width:780px;")) ?></td>
            </tr>
