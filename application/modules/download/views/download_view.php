...
<div id="rightPanel">
    ...
    <div class="pageTitle">
        <ul>
            ...
            <li><a href="<?=base_url()?><?= url_title($this->meslekname) ?>/download/<?=url_title($kategori->name)?>-<?=$kategori->id?>dk.html"><?=$kategori->name?></a></li>
        </ul>
    </div>
    ...
    <div style="float:left; width:350px; margin-top:10px;">
        <img src="images/download.png"> <span style="font-size:18px; font-weight: bold; letter-spacing: -1px; color:#333333;"><?=$kategori->name?><br><div class="smalldesc"><?=$kategori->description?></div></span>
    </div>
        ...
        <div style="">
            ...
            <div style="float:left; padding:30px 0 20px 0; width:310px; height: 80px; margin-right: 20px;" class="borderbottom">
                ...
                <div style="font-size:11px; padding: 6px 0 0 4px; color:#999999; float:right;"> 
                    ...
                    <? endforeach; ?>
            <? } else { ?> 
                <div class="warning">"<?=$kategori->name?>" kategorisinde dosya bulunamadı!</div>
            <? } ?>
        </div>
