...
<script type="text/javascript">
   ...
   function loginSubmit(){
      ...
      if($("#code").val()==""){
         $("#result").html(resultFormat("warning","<?=lang("Aktivasyon Kodunu Giriniz!")?>"));
         return false;
      }
      ...
      $.ajax({
         type:'POST',
         url:'<?php echo base_url() ?>account/activationCheck',
         data: $("#activationForm").serialize(),
         dataType:'json',
         success:function(respond){  
            if(respond.success=="true"){
               document.getElementById("activationForm").reset();
               $("#result").html(resultFormat("success","<?=lang("Üyeliğiniz aktif hale getirilmiştir. E-Posta Adresiniz ve şifreniz ile sitemize giriş yapabilirsiniz.")?>"));
...
<div id="centerPanel">
   <?php echo openBlock(lang("Üyelik Aktivasyonu"),"grey600") ?>
      <div style="padding:10px;">
         <?php echo form_open("", array("name" => "activationForm", "id" => "activationForm")); ?>
         <table width="100%" cellpadding="2" class="formTable">
            <tr>
               <td>
                  <span class="smalldesc"><?php echo lang("aktivasyon_form_aciklama") ?> <?php echo lang("login_form_aciklama2") ?></span>
            ...
            <tr><td><?php echo form_input(array("id" => "email", "name" => "email", "style" => "width:180px; margin-bottom:4px;","value"=>(isset($_GET['email']))? $_GET["email"] : "")); ?></td></tr>
            <tr><td style="border-bottom:0"><?php echo lang("Aktivasyon Kodu", "activationcode", lang("Posta Kutunuza gelen aktivasyon kodu")) ?><td></tr>
            <tr><td><?php echo form_input(array("id" => "activationcode", "name" => "activationcode", "style" => "width:180px; margin-bottom:4px;","value"=>(isset($_GET['code']))? $_GET["code"] : "")); ?></td></tr>
            <tr>
               <td> 
                  <?php echo form_button(array("name" => "login", "content" => lang("Üyeliğimi Aktif Hale Getir"), "class" => "blue", "style" => "width:200px;"), "", "onclick='loginSubmit()'") ?>
                  <?php echo form_button(array("name" => "resett", "content" => lang("Vazgeç"), "class" => "grey", "style" => "width:72px;"), "", "onclick='this.form.reset()'") ?>
               </td>
            </tr>
         </table>
         <?php echo form_close() ?>
